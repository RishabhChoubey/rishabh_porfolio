...
import { github ,rishabh} from "../assets";
...
const ProjectCard = ({ project, index }) => {
  return (
    <motion.div variants={zoomIn(0.5, 0.75)}>
      <Tilt
        options={{
          max: 45,
          scale: 1,
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            >
              <img src={rishabh} alt="open" className="w-1/2 h-1/2 object-contain" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-secondary text-[14px]">{project.sub_des}</p>
        </div>
